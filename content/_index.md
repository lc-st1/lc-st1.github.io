...
sections:
  ...
  - block: markdown
    content:
      ...
      subtitle: ''
      text: |-
        I am interested in the study of mechanical design and control for bio-inspired robotics. The recreation of anatomical and physiological structures using mechanical components fascinates me, and my research focuses on the application of biomimetic designs to multimodal systems, particularly flapping-wing, legged, and aquatic robots.
    design:
      columns: '1'
  # - block: collection
  #   id: papers
